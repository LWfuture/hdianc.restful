...
@RunWith(Suite.class)
@SuiteClasses( {
	DoDiExchangeRateRestEasyTests.class,
	//DoDiUserOperationLogAopTests.class
	})
public class ExchangeRateTomcatRestSqlServerSuit {

	protected static final Logger LOG = Logger.getLogger(ExchangeRateTomcatRestSqlServerSuit.class);
...
//		TomcatWebServerTestManager.shutdownEmbeddedServer();
	...
	private static void initDataSourceProperties() throws IOException {
		URL url = ClassLoader.getSystemResource("datasource/db-server.properties");
